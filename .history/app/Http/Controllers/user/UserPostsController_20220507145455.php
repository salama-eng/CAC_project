...
class UserPostsController extends Controller
{
    ...
    public function save_post(Request $request){
        Validator::validate($request->all(),[
            ...
            'auction_price' => "required|integer|regex:/^\d+(\.\d{1,2})?$/|not_regex:/[a-z]/|min:100000",
            ...
            'auction_price.min'         =>'سعر سقف المزايدة يجب ان لا يقل عن 100000 ',
    ...
    public function uncomplate(){
        ...
        $posts=Post::with(['auction_post'])->where('user_id',$id)->get();
