...
<div class="dash-header col-lg-12  col-11 m-auto mt-5 d-flex justify-content-center align-items-center">
  ...
  <div class="dash-header1 col-8">
      ...
      <h6 class=" p-3 active"><span class="text-white f-size">   رقم المحفضة : 54 </span>  {{ Auth::user()->id }} </h6>
  </div>
...
<button class="bg-yellow text-white py-2 px-3 m-2 p-dash">اجمالي المبلغ في المحفضة : </button>
