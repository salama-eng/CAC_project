...
@if($do == 'Manage')
    ...
    @elseif($do == 'Edit')
    <div class=" col-5 m-auto edite-container p-2">
    <h1 class="text-center fs-4 mt-5 mb-5"> تعديل الصورة </h1>
<form action="">

    <input class="image m-auto" type="file" name="image">
    <input type="submit" value="حفظ"class="image btn-primary mt-2 mb-2" type="file" name="image">
</form></div>
    @endif
@endsection
