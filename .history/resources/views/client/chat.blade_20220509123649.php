    ...
    <main class="">
      ...
      <ul id="chat" class="" style="height:70vh">
        ...
        <button class="btn btn-success" id="btn-add">
          ...
          <div class="modal fade" id="formModal" aria-hidden="flase">
      ...
      </ul> <form id="myForm" name="myForm" class="form-horizontal" novalidate="">
      <div class="d-flex col-12 justify-content-around ">
       
        <input type="text" class="form-control" id="title" name="message"
