...
<h5 class="card-title text-center">{{$order->post->name}}</h5>
            ...
            <div class="card-body d-flex justify-content-between py-0">
                <p href="#" class="card-link card-details fs-7">سعر المزايدة/<span class="active"> {{$order->post->auctions[1]->bid_total}}$</span>
                </p>
            ...
            <div class="card-body d-flex justify-content-between py-0">
                ...
                <a href="{{route('auctiondetails',$order->post->id)}}" class="card-link active bg-darkgrey p-1 card-btn px-3 m-1 text-white  fs-7"> الدردشة<i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
