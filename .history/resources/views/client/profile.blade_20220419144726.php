...
@section('content')
    <div class="profile-container d-flex flex-wrap g-5  align-items-center m-5">

        <div class=" align-self-end col-lg-3 col-md-5 col-12 d-flex flex-column align-items-center">
        ...
        <div class=" col-lg-5 col-md-5 col-11 text-white text-end">
