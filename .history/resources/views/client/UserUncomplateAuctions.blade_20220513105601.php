...
<div class="card text-light m-auto my-4" style="width: 18rem;">
    ...
    <div class="card-body d-flex justify-content-between py-0">
        ...
        <a href="#" class="card-link card-details fs-7 bg-yellow p-1 px-3 m-1 card-btn text-white"> ارسال المبلغ </a>
         ...
         <a href="{{route('chat',$auction->id)}}" class="card-link active bg-darkgrey p-1 card-btn px-3 m-1 text-center w-50 m-auto  fs-7"> الدردشة<i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
</div>
