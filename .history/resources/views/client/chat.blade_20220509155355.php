...
@section('content')
    <div id="container" class="col-12 ">
        ...
        <div class="modal-body d-flex justify-content-around">
            <form id="myForm" name="myForm" class="form-horizontal" novalidate="" class="col-8">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control" id="message" name="message" placeholder="ادخل نص الرسالة "
                        value="">
