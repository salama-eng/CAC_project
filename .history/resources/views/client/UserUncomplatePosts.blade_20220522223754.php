...
<div class="card text-light m-auto my-4" style="width: 18rem;">
    ...
    <div class="card-body d-flex justify-content-between py-0">
        ...
        <button type="submit"  value=" الدردشة " class="card-link active bg-darkgrey p-1 card-btn px-2 m-1 text-center w-75 m-auto my-2 fs-7"> <i class="bi bi-chat-right-text-fill"></i>
