...
@section('content')
    <div class="profile-container d-flex flex-wrap g-5  align-items-center">
        ...
        <div class=" align-self-end col-lg-5 col-md-5 col-11 d-flex flex-column align-items-center">
        ...
        <div class=" col-lg-6 col-md-5 col-11 m-lg-0 m-auto text-white text-end">
