...
<div class="card text-light m-auto my-4" style="width: 18rem;">
    ...
    <div class="card-body justify-content-between py-0">
                    
      
  
       
         </div> <a href="#" class="card-link card-details fs-7 bg-yellow p-1 px-3 m-1 card-btn text-white">لم يتم الاستلام </a>
         <a href="#" class="card-link card-details fs-7 bg-yellow p-1 px-3 m-1 card-btn text-white">لم يتم ارسال المبلغ  </a>
