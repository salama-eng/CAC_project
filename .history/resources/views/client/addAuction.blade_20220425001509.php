...
@section('content')
    <form class="container px-5 fs-6 d-flex flex-wrap" action="save_post" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 w-50 px-2 w-lg-100">
            <label for="" class="form-label text-white">مقدار المزايدة. <span class="yellow fs-6"> لا يقل عن 100 الف</span></label>
            <div class="input-group">
        ...
        <div class="mb-3 w-50 px-2 w-lg-100">
            ...
            <div class="input-group">
                <input type="date" name="end_date" value="{{old('end_date')}}" placeholder="تاريخ انتهاء العرض" class="form-control" id="basic-url"
                    aria-describedby="basic-addon3">
            </div>
            @error('end_date')
              <span class="text-end yellow">* {{ $message }}  </span>
