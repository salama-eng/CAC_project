...
<section class="container d-flex flex-wrap justify-content-between ">
  ...
  <div class="card text-light m-auto" style="width: 18rem;">
    <div class="crop">
      <img src="{{ URL::asset('images/car4.jpg') }}" class="card-img-top " alt="..."></div>
      <div class="card-body">
          <h5 class="card-title text-center">Mercedes-Benz</h5>
          <p class="text-center fs-7 card-details">جديد</p>
  ...
  <div class="card text-light m-auto" style="width: 18rem;">
    <div class="crop">
      <img src="{{ URL::asset('images/car5.jpg') }}" class="card-img-top " alt="..."></div>
      <div class="card-body">
          <h5 class="card-title text-center">Mercedes-Benz2</h5>
          <p class="text-center fs-7 card-details">جديد</p>
