...
@section('content')
    <div class="profile-container d-flex flex-wrap g-2  align-items-center">

        <div class=" align-self-center col-lg-3 col-md-5 col-12 d-flex flex-column align-items-center">
