...
<body style="width:100%; height:100%; background-repeat: no-repeat;
  background-image: url(assets/back.jpg); background-size:cover">
    ...
    <div class="login-container d-flex  align-items-center justify-content-around flex-wrap">
        ...
        <div class="login-image col-lg-5 col-11">
        ...
        @endif
                ...
                <input name="text" type="text" placeholder=" العنوان ">
                <input name="text" type="text" placeholder=" رقم التلفون ">
                <input name="image" type="file" title = "Choose a video please">
                <input name="text" type="text" placeholder=" رقم الحساب في باي بال">
