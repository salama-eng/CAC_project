            ...
            <header class="d-flex justify-content-end align-items-center gap-5 text-end">
              <p class="align-self-end mr-auto"><a href="{{ route('profile') }}" class="card-link active text-warning mt-3 mb-2"> العودة
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <p class="align-self-end mr-auto d-block d-lg-none " style="font-size:12px"><a href="{{ route('profile') }}" class="card-link active text-warning mt-3 mb-2"> 
                       <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a></p>
                </div>
