...
<div class="card text-light m-auto my-4" style="width: 18rem;">
    ...
    <div class="card-body py-0">
        ...
        <p class="text-center fs-7 card-details"> انتهت في  <em> {{$post->end_date}} </em></p>
    </div>
    ...
    <div class="card-body d-flex justify-content-between py-0">
        ...
        <input type="submit" class="card-link active bg-darkgrey p-1 card-btn px-2 m-1 text-center w-75 m-auto my-2 fs-7"> الذهاب للدردشة  <i class="fa fa-long-arrow-left p-2 pt-1"> </i></input>
