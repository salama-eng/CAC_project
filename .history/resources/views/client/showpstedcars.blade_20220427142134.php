...
<div class="card text-light m-auto my-4" style="width: 18rem;">
    ...
    <div class="card-body d-flex justify-content-between py-0">
        <p href="#" class="card-link card-details fs-8">سعر المزايدة/<span class="active"> {{$post->starting_price}}$</span>
        </p>
        <a href="{{route('auctiondetails',$post->id)}}" class="card-link active  fs-8">تفاصيل<i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
    </div>
</div>
