...
<section class="container d-flex flex-wrap justify-content-between ">
  <div class="card text-light m-auto" style="width: 18rem;">
      <img src="{{ URL::asset('images/car1.png') }}" height="220" class="card-img-top crop" alt="...">
      <div class="card-body">
  ...
  <div class="card text-light m-auto" style="width: 18rem;">
      ...
      <div class="card-body">
          <h5 class="card-title text-center">Mercedes-Benzx</h5>
          <p class="text-center fs-7 card-details">جديد</p>
  ...
  <div class="card text-light m-auto" style="width: 18rem;">
      <img src="{{ URL::asset('images/car5.jpg') }}" class="card-img-top crop" alt="...">
      <div class="card-body">
          <h5 class="card-title text-center">Mercedes-Benz</h5>
          <p class="text-center fs-7 card-details">جديد</p>
