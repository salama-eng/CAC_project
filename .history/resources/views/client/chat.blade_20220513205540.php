...
@section('content')
    <div id="container" class="col-12 ">
        ...
        <main class="">
            <header class="d-flex justify-content-end align-items-center gap-5 text-end">
              <p class="align-self-end mr-auto"><a href="{{ route('UserDash') }}" class="card-link active text-warning mt-3 mb-2"> العودة
                للرئيسية <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a></p>
                <div class="col-lg-3 col-6">
                    <h2> mmmm </h2>
                    <h3 class="d-lg-block d-none">already 1902 messags</h3>
                    <p class="align-self-end mr-auto d-block d-lg-none " style="font-size:12px"><a href="{{ route('UserDash') }}" class="card-link active text-warning mt-3 mb-2"> العودة
                      للرئيسية <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a></p>
                </div>
 ...
 <input type="hidden" id="post_id" name="post_id" value="1">
                    ...
                    <input type="hidden" id="user_name" name="user_name" value="1">
