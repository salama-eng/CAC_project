...
@endphp
            ...
            <div class="card text-light m-auto my-4" style="width: 18rem;">
                ...
                <div class="card-body d-flex justify-content-between py-0">
                    ...
                    <a href="{{route('auctiondetails',$auction->auction_post->id)}}" class="card-link active bg-grey p-2 px-3 m-2 text-white  fs-7"> الدردشة<i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
