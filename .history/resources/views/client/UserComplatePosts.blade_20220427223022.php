...
<h5 class="card-title text-center">{{$post->name}}</h5>
    ...
    <div class="card-body d-flex justify-content-between py-0">
        ...
        <a href="#" class="card-link card-details fs-7 bg-danger m-auto p-1 px-3 my-2 card-btn text-white text-center ">  لم تتم المزايدة <i class="fa fa-x-circle p-2 pt-1"></i></a>
         </div>
