...
@if(isset(Auth::user()->profile->avatar))
    ...
    @endforeach
        ...
        <div class="mb-3 w-50 px-2 w-lg-100">
            ...
            <div class=" d-flex">
                <input class="form-check-input mx-2" type="radio" name="care_type" value="جديد" {{ (old('care_type') == 'جديد') ? 'checked' : ''}}  id="flexRadioDefault1">
                ...
                <input class="form-check-input mx-2" type="radio" name="care_type" value="مستخدم" {{ (old('care_type') == 'مستخدم') ? 'checked' : ''}} id="flexRadioDefault2">
                <div class="form-check ">
