...
<div class="card text-light m-auto my-4" style="width: 18rem;">
    ...
    <a href="{{route('chat',$auction->id)}}" class="card-link active bg-darkgrey p-1 card-btn px-3 m-1 text-center  fs-7"> الدردشة<i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
    <div class="card-body d-flex justify-content-between py-0">
