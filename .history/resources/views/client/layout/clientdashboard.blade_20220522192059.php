        ...
        <div class="holder aside">
            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled components fs-6 mt-4 " style="text-align:right">
                    <li>
                        <a href="{{route('UserDash')}}" class=" p-3 text-light"><h6 ><i class="bi bi-house-fill active mx-2"></i>  الرئيسية</h6></a>

                    </li>
                    <li>
                        <a href="{{route('wallet',Auth::id())}}" class=" p-3 text-light"><h6><i class="bi bi-cash-stack active mx-2">  </i>  معلومات المحفضة</h6></a>

                    </li>
                    <li>
                       <a href="{{route('profile')}}"class=" p-3 text-light "><h6 ><i class="bi bi-person-bounding-box active mx-2">  </i>  المعلومات الشخصية</h6></a> 

                    </li>
                    <li class="active dropdown">
                     <h6>   <a class="dropdown-toggle text-warning text-light pb-2" data-toggle="collapse"
                            aria-expanded="false"><i class="bi bi-menu-button-fill active mx-2"></i> إدارة
                            طلبات إضافة مزاد</a></h6>
                        <ul class="collapse list-unstyled fs-6" id="manage">
                            <li><a href="{{route('addAuction')}}" class="text-light  p-3">إضافة مزاد</a></li>
                            <li><a href="{{route('postedcars')}}" class="text-light  p-3"> السيارات المضافة في المزاد</a></li>
                            <li><a href="{{route('UserUncomplatePosts')}}" class="text-light p-3"> مزادات غير مكتملة البيع</a></li>
                            <li><a href="{{route('UserComplatePosts')}}" class="text-light  p-3"> المزادات المكتملة</a></li>
                    ...
                    <li class="active dropdown2">
                        ...
                        aria-expanded="false"> <i class="bi bi-menu-button-fill active ml-4"></i> إدارة
                        طلبات المزايدة</a></h6>
...
<li>  <a href="{{route('home')}}" class="card-link active  mt-5 mb-2 text-center"> العودة للرئيسية <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a></li>
                </ul>
        ...
        <div class="w-100 bg-grey"  style="">
            ...
            <div class="text-light dirction me-auto mt-4 dropdown-notifications d-block ms-5">
                ...
                <ul class="dropdown-menu bg-noty userinfo text-center p-0" style="width:15rem">
                    <li>
