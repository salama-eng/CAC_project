        ...
        <div class="holder aside">
            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled components fs-6 mt-4 " style="text-align:right">
                    <li>
                        <a href="{{route('UserDash')}}" class=" p-2 text-light"><h6 ><i class="bi bi-house-fill active mx-2"></i>  الرئيسية</h6></a>

                    </li>
                    <li>
                        <a href="{{route('wallet',Auth::id())}}" class=" p-2 text-light"><h6><i class="bi bi-cash-stack active mx-2">  </i>  معلومات المحفضة</h6></a>
