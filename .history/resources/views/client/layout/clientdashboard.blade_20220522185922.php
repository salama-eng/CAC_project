    ...
    <div class="d-flex">
        ...
        <div class="holder aside">
            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled components fs-6 mt-4" style="text-align:left">
                    <li>
                        <a href="{{route('UserDash')}}" class="text-center p-3 text-light"><h6 ><i class="bi bi-house-fill active"></i>  الرئيسية</h6></a>

                    </li>
                    <li>
                        <a href="{{route('wallet',Auth::id())}}" class="text-center p-3 text-light"><h6><i class="bi bi-cash-stack active"></i>  معلومات المحفضة</h6></a>
