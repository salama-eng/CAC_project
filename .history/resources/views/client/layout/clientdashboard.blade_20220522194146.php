        ...
        <div class="holder aside">
            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled components fs-6 mt-4 " style="text-align:right">
                    <li>
                        <a href="{{route('UserDash')}}" class=" px-3 py-3 text-light"><h6 ><i class="bi bi-house-fill active mx-2"></i>  الرئيسية</h6></a>
                    </li>
                    <li>
                    ...
                    <li class="active dropdown2">
                        ...
                        <ul class="collapse list-unstyled fs-6" id="manage2">
                            <li><a href="{{route('AuctionCars')}}" class="text-light p-3"><i class="bi bi-box-arrow-in-down active me-5 p-2"> السيارات التي تمت المزايدة عليها</a></li>
