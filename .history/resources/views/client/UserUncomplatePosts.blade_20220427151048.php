...
@endphp
            ...
            <div class="card text-light m-auto my-4" style="width: 18rem;">
                ...
                <div class="card-body d-flex justify-content-between py-0">
                    <a href="#" class="card-link card-details fs-7 bg-yellow p-2 px-3 m-1 text-white">تاكيد الاستلام 
                    </a>
                    <a href="{{route('auctiondetails',$auction->auction_post->id)}}" class="card-link active bg-yellow p-2 px-3 m-1 text-white  fs-7">الذهاب للدردشة<i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
                </div>
            </div>
