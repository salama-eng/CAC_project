...
<div class="dash-header col-lg-12  col-11 m-auto mt-5 d-flex justify-content-center align-items-center">
  ...
  <div class="dash-header1 col-8">
      ...
      <h6 class=" p-3 active"><span class="text-white f-size">   رقم المحفضة :  </span>  54{{ Auth::user()->id }} </h6>
  </div>
...
<button class="bg-yellow text-white py-2 px-3 m-2 p-dash fs-4">اجمالي المبلغ في المحفضة : 455</button>
<button class="bg-yellow text-white py-2 px-3 m-2 p-dash">طلب المبلغ</button>
</div>
...
<div class="dash-content d-flex flex-wrap justify-content-around m-auto" >
          ...
          <div class="card-wallet text-light p-3">
              ...
              <div>
                <p class="fs-6 p-dash "> من  رقم حساب  <span class="active">(5536)</span> المستخدم <span class="active">خليفة القاضي</span></p>
                <p class="fs-7 p-dash grey ">@php
                 echo now();
                @endphp</p>
            </div>
                <p class="fs-3 green">+ 1000 $</p> 
