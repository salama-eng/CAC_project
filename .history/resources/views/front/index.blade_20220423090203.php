...
@section('content')
    <section class="">
        ...
        <div class="about mt-5 mb-5 d-flex flex-wrap">
          <div class="d-flex col-lg-6 col-11">
            ...
            <div>
            <h3 class="col-12">مزادات كاك</h3>
       <a class="text-warning fs-8 align-self-end col-12" href="">تعرف اكثر <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
