...
@section('content')
    ...
    <main class="d-flex justify-content-center align-items-center mt-5 ">
        ...
        <div class="text container text-center col-11 col-lg-6 ">
            ...
            <p class="fs-3 fw-bold ">نحن نعمل باستمرار لجعل تجربتكمن خلال الخدمات أسهل, سنقوم بالرد على رسائلكم خلال 24
                ساعة.</p>
    ...
    <section class="send_message  position-relative ">
        ...
        <div class="yellow_box d-none d-md-block top-0  bg-yellow z-8"></div></div>
