            ...
            <div class="card text-light m-auto  py-0 mb-3" style="width: 18rem;">
             <a href="{{route('auctiondetails',$auction->auction_post->id)}}"> <img src="/images/{{$auction->auction_post->image}}" class="card-img-top p-3" height="220" alt="..."></a>
                ...
                <div class="card-body d-flex justify-content-between py-0">
                    ...
                    <a href="#" class="card-link active  data-bs-toggle="modal" data-bs-target="#auction{{$auction->auction_post->id}}"> </i></a>
                    <a href="" class='btn btn-danger activate' data-bs-toggle="modal" data-bs-target="#auction{{$auction->auction_post->id}}">
