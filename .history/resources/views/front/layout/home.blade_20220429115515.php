        ...
        <div class="container-fluid w-96 my-2">
            ...
            <div class="collapse navbar-collapse ">
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0 w-75 d-flex justify-content-between fs-7">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link text-light" href="login">تسجيل الدخول
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link text-light" href="regester">انشاء حساب
                        </a>
                    </li>
        ...
        <div class="container-fluid  d-flex mx-auto w-75 justify-content-between flex-wrap">
            ...
            <div class="py-5 px-4 col-12 col-lg-2">
                ...
                <p class="text-light mt-3">
                    ...
                    <a href="{{route('/')}}" class="d-block text-light py-1">خدماتنا</a>
                    <a href="{{route('/')}}" class="d-block text-light py-1">كيفية الاستخدام</a>
                </p>
