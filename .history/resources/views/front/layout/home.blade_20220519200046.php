...
@endif
  ...
  <style>.bg-noty
    ...
    <ul class="dropdown-menu bg-noty fs-7 p-0 " aria-labelledby="dropdownMenu2" style="width:13rem;">
      ...
      <li><button class="dropdown-item  text-start fs-7 mt-2" type="button">  <a href="{{route('profile')}}" class=" card-link active">البروفايل <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a></button></li>
