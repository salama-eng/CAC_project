...
@endif
    ...
    <ul class="dropdown-menu bg-dark text-left yellow text-lighter" aria-labelledby="dropdownMenu2">

      <li><button class="dropdown-item text-white text-end  " type="button"> {{Auth::user()->name}}
        

     </button></li>
      <li><button class="dropdown-item text-white  text-end " type="button">  {{Auth::user()->email}}</button></li>
