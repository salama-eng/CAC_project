...
<div class="dropdown">
    <img src="/assets/images/avatar.png" class="rounded-circle dropdown-toggle nav-item text-center border-0  contact text-light fs-6 py-2 px-4 me-auto ms-5 "type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
    <button class="btn btn-secondary dropdown-toggle nav-item text-center border-0  contact text-light fs-6 py-2 px-4 me-auto ms-5 "type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
      Dropdown
    </button>
