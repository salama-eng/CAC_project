        ...
        <div class="holder aside">
            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled components fs-6 mt-4 ">
                    <li>
                        <h5 class="text-center p-3 text-light mb-4">المعلومات الشخصية</h5>
                    ...
                    <ul class="collapse list-unstyled fs-6" id="manage">
                        <li><a href="/addAuction" class="text-light text-center p-3">إضافة مزاد</a></li>
                    ...
                    <li>
                        <div class="d-flex flex-column justify-center">
                            <div class="bg-yellow p-2  mb-2 ">
                                <img src="assets/images/avatar.jpg" class=" rounded-circle m-auto mt-1 " width="50"
                                    alt="">
                            </div>
