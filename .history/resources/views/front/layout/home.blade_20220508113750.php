...
@endif
    ...
    <ul class="dropdown-menu bg-dark text-left yellow text-right" aria-labelledby="dropdownMenu2">
      ...
      <li><button class="dropdown-item text-white  " type="button">  {{Auth::user()->email}}</button></li>
     

      <li><button class="dropdown-item" type="button">  <a href="{{route('profile')}}" class="card-link active">البروفايل <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a></button></li>
