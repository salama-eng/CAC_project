...
@endif
    ...
    <ul class="dropdown-menu bg-dark fs-6  yellow " aria-labelledby="dropdownMenu2">

      <li><button class="dropdown-item text-white text-end text-light " type="button"> {{Auth::user()->name}}
