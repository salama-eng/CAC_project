            ...
            <div class="text-light dirction me-auto mt-4">
              <div class="d-flex justify-content-end">
                ...
                <ul class="dropdown-menu bg-dark userinfo text-center">
                    ...
                    <li class="d-flex"> <img src="assets/icons/logout.png" class=" rounded-circle m-auto mt-1 " width="50" alt="" > <a class="dropdown-item text-light fs-7" href="#">تسجيل الخروج</a>
                        <p class="dropdown-divider mx-2"></p>
                    </li>
                </ul>
            </div>
