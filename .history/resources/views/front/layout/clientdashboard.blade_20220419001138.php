                ...
                <ul class="dropdown-menu bg-dark userinfo text-center">
                    <li>
                       <div class="d-flex flex-column justify-center">
                        ...
                        <hr class="text-white ">
                        <h6 class="dropdown-item text-light mt-1 " href="#">اسم المستخدم
                        </h6>
                    </div>
                    </li>


                    <li class="d-flex justify-content-start align-items-center"><a class="dropdown-item text-light " href="#">تسجيل الخروج</a> <img src="assets/icons/logout.png" class="  " width="20" height="20" alt="" > 
