...
<input type="hidden" class="nav-item text-center border-0  contact text-light fs-6 py-2 px-4 me-auto ms-5 ">
    <i class="fa fa-sign-in"></i>&nbsp;تسجيل الدخول
</input>
<div class="dropdown">
    <img src="/assets/images/avatar.png" class="rounded-circle dropdown-toggle nav-item  border-0  contact me-auto " id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false" width="60" height="">
