...
<div class="dropdown">
    ...
    <img src="/images/{{Auth::user()->profile->avatar}}" width="80" class="rounded-circle dropdown-toggle nav-item  border-yellow   contact me-auto mx-5" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false" width="50px" height="">
@else

<img src="/assets/images/avatar.png" class="rounded-circle dropdown-toggle nav-item  border-yellow   contact me-auto mx-5" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false" width="50px" height="">
