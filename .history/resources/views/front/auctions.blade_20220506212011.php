                    ...
                    <div class="modal-content ">
                        <form action="{{ route('bid_auction',$auction->auction_post->id) }}" method="post">
                            ...
                            <div class="modal-body bg-darkgrey  p-3  ">
                                ...
                                <h2 class="text-white fs-5 pb-3 "> هل انت متاكد تريد المزايدة على هذة السيارة ودفع مبلغ مضاف الى قيمتها الحالية التي تقدر ب   <em class="yellow"> {{$auction->bid_total }}$</em></h2>
