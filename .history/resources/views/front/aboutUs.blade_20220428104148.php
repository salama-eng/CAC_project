...
<main class=" main-contact d-flex justify-content-center align-items-center mt-5 ">
    ...
    <div class="text container aboutheader ">
        ...
        <p class=" ">شركة مزاد تأسست في 1982 بواسطة ويليس ج. جونسون، وبدأت كساحة واحدة في كاليفورنيا. 
        ...
        <a href="{{route('contact_us')}}" class=" border1 text-center fs-5 mt-5 mb-2 px-3 py-2"> تواصل معنا  <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
    </div>
</main>
