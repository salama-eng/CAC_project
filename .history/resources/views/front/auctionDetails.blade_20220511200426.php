...
<style>
    ...
    <section class="d-flex container mt-5 flex-wrap col-lg-9">
        <section class="col-12  col-lg-6 mt-5">
            <div class="mt-5"><h3 class="active "><span class="card-details fs-6"> السعر الاولي/</span>
                {{$post->starting_price}}$
                </h3>
                <a href="" class="d-flex card-details fs-6 mb-5"><span class="fa fa-long-arrow-right pt-2 px-2"></span>رجوع</a>
            ...
            class="yellow">{{ $post->starting_price + $post->auction_ceiling }}$</em>
                                    ...
                                    <div class="d-flex  align-items-center gap-3 ">
                                        ...
                                        <input type="number" class="input-model text-white p-2"
                                            ...
                                            value="" name="amount" placeholder="مقدار الزيادة"/>
                                    </div>
                                </div>
                                    @php
        ...
        <section class="col-lg-6 col-sm-12 mt-5">
            <div class="col-12 d-flex justify-content-between align-items-center">
                <div>
                        ...
                        <h5 class="active my-1"> <span class="card-details fs-6"> السعر الحالي/ </span>
                ...
                <h3 class="text-light fw-bold mt-2">{{$post->name}}/ <span>{{$post->model}}</span></h3>
