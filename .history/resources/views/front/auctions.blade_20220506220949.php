            ...
            <div class="modal fade user" id="auction{{$auction->auction_post->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content m-auto ">
                       <h5 class="text-center yellow mt-5">عذرا يرجى تسجيل الدخول اولا حتى تتمكن من المزايدة!!</h5>
                        <img src="/assets/images/login_error.png" width="300" alt="">
                        <a href="{{route('login')}}" class="card-link active text-center mt-5 mb-2"> تسجيل الدخول <i class="fa fa-long-arrow-left p-2 pt-1"> </i></a>
                    </div>
                </div>
