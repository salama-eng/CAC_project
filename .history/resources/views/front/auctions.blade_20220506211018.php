                    ...
                    <div class="modal-content  ">
                        <form action="{{ route('bid_auction',$auction->auction_post->id) }}" method="post">
                            ...
                            <div class="modal-body bg-darkgrey ">
                                ...
                                <h2 class="text-white fs-5 pb-3"> المبلغ الحالي للسيارةهو <em class="yellow">{{$auction->bid_total }}$</em></h2>
                            ...
                            <p class="yellow fs-8 mt-2">*يجب ان تكون مقدار الزيادة من مضاعفات {{$auction->auction_post->auction_ceiling }}$</p>
                            </div>
