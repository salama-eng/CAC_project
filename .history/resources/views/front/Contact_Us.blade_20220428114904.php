...
<main class=" main-contact1 d-flex justify-content-center align-items-center mt-5 ">
    ...
    <div class="text container aboutheader text-center">
        <h1 class="mt-5   mb-5  yellow fw-bold "> <i class="fa fa-long-arrow-left p-2 pt-1"> </i> تواصل معنا </h1>
        <p class="  mb-5"> نحن نعمل باستمرار لجعل تجربتك من خلال الخدمات أسهل, سنقوم بالرد على رسالتكم خلال 24 ساعة
        </p>
