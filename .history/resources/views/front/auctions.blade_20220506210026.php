                    ...
                    <div class="modal-content  ">
                        <form action="{{ route('bid_auction',$auction->auction_post->id) }}" method="post">
                            ...
                            <div class="modal-body bg-darkgrey ">
                                ...
                                <h2 class="text-white fs-4 p-3"> المبلغ الحالي للسيارة <em class="yellow"><script>x</script> {{$auction->bid_total }}$</em></h2>
                                <div class="d-flex  align-items-center gap-3">
                                <h3 class="text-white fs-6"> يرجى اضافة مقدار الزيادة </h3>
                                <input type="number" class="input-model text-white" min="{{$auction->auction_post->auction_ceiling}}"
                                 step="{{$auction->auction_post->auction_ceiling}}" id="myInput" oninput="myFunction()"
                                 value="{{$auction->auction_post->auction_ceiling}}"  name="amount ">
                            </div>
                            <p class="yellow mt-2">*يجب ان تكون مقدار الزيادة من مضاعفات {{$auction->auction_post->auction_ceiling }}$</p>
                            </div>
