                    ...
                    <div class="modal-content  ">
                        <form action="{{ route('bid_auction',$auction->auction_post->id) }}" method="post">
                            ...
                            <div class="modal-body bg-darkgrey ">
                                ...
                                <input type="number"  min="{{$auction->auction_post->auction_ceiling}}" step="{{$auction->auction_post->auction_ceiling}}" value="{{$auction->auction_post->auction_ceiling}}"  name="amount">
                            </div>
                            </div>
