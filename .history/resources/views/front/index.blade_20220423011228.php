...
@section('content')
    <section class="">
        ...
        <div class="landscape g-4 d-flex flex-wrap mb-5 pb-5 ">
            ...
            <div
                class="landscape-text col-lg-6 col-8  d-flex flex-wrap justify-content-center align-content-center align-items-center  m-1 p-1 m-lg-5 p-lg-5 ">
        ...
        <div class="mt-5 col-10 col-lg-8 m-auto pt-5">
            <h1 class=" yellow mt-4 text-center m-5">البراندات</h1>
            <div class="brands d-flex justify-content-around flex-wrap">


                <img class="img-fluid" src="brand/1.png" width="150px" height=""alt="">
                <img class="img-fluid"  src="brand/3.png" width="150px" height=""alt="">
                <img  class="img-fluid" src="brand/4.png" width="150px" height=""alt="">
                <img class="img-fluid" src="brand/5.png" width="150px" height=""alt="">
