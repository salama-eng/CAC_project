            ...
            <div class="col-12 d-flex justify-content-between align-items-center mt-4">
                <div>
                    ...
                    @if (isset($post->auctions[0]->bid_total))
                        <h5 class="active text-light fw-bold card-details "> <span class="card-details fs-6"> السعر الحالي/ </span>
                            {{ $post->auctions->max('bid_total') }}$
                        </h5>
                    @else
                        <h3  class="active text-light fw-bold card-details"> <span class="card-details fs-5"> السعر الحالي/ </span>
                            {{ $post->starting_price }}$
                        </h3>
                    @endif
                </div>
