...
<div class="landscape-text col-lg-6 col-10  d-flex flex-wrap justify-content-around g-5 m-lg-5 p-lg-5">
  ...
  <h1 style="font-size: 2vw;" class="text-white  col-lg-12 mt-lg-4 ">لجميع السيارات والشاحنات المستعملة والجديدة تجعل من السهل على الاعضاء العثور والمزايدة على جميع السيارات </h1>
