        ...
        <div class="table-responsive text-white">
            <table class="main-table manage-members text-center table table-bordered  text-white">
                ...
                <tr>
                    <td>{{$category->id}}</td>
                    <td>{{$category->name}}</td>
                    <td><img src="images/{{$category->image}}" width="80"></td>
                    <td>
...
<div class="container">
    ...
    @foreach($category as $cat)
        @if($cat->id == $categoryid)
            <form action="edit_admin_category" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8 col-md-9">
                        ...
                        <input type="hidden" name="image-old" value="{{$cat->image}}" class="form-control" autocomplete="off" placeholder="ادخل اسم البنك">
                    </div>
                </div> 
                <div class="form-check d-flex  justify-content-center mt-5 ">
