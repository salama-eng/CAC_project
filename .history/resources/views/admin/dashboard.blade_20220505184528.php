...
@section('content')
    <section>
        ...
        <div class="dash-content d-flex flex-wrap justify-content-around col-10 m-auto mt-4 ">
            <div>
              ...
              <div>
                  <div class="card-admin text-light p-2" style="width:12rem">
                      ...
                      <div>
                          <p class="fs-7 grey">عدد المزايدات في الموقع</p>
                      </div>
                  </div>
              </div>
              ...
              <div>
                <div class="card-admin text-light p-2" style="width:12rem">
                    ...
                    <div>
                        <p class="fs-7 grey">عدد السيارات  في الموقع</p>
                    </div>
                </div>
            </div>
            ...
            <div>
              <div class="card-admin text-light p-2" style="width:12rem">
                  ...
                  <div>
                      <p class="fs-7 grey"> عمليات الشراء في الموقع</p>
                  </div>
              </div>
          </div>
