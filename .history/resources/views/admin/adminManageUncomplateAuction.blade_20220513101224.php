                        ...
                        @foreach($post->auctions as $bid_total)
                            ...
                            <tr>
                                ...
                                <td>   @if ($admin_confirm==0)
                                    <p href="" class='btn activate accept' data-bs-toggle="modal" style="" data-bs-target="#active{{$post->id}}">
                                        <i class='fa fa-check'></i> موافقة
                                    </p>
                                     @else
                                     <a href="" class='btn active' data-bs-toggle="modal" style="" data-bs-target="#active{{$post->id}}">
