            ...
            <table class="main-table manage-members text-center table table-bordered  text-white">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('active_admin_category',$categoryid) }}" class='btn btn-danger' data-bs-toggle="modal" data-bs-target="#deletecategory{{$category->id}}">
                            <i class='fa fa-close'></i> Delete
                        </a>
                        @if($category->is_active == 1)
                            <a href="{{ route('active_admin_category',$categoryid) }}" class='btn btn-info activate' data-bs-toggle="modal" data-bs-target="#activeCategory{{$category->id}}">
