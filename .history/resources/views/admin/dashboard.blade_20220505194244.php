...
<div class="dash-content d-flex flex-wrap ustify-content-around m-auto" >

        <div class=" d-flex flex-wrap justify-content-around col-lg-6 col-11 m-auto mt-4 gap-2 ">
            <div>
