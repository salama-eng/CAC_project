    ...
    <div class="container">
        ...
        <div class="table-responsive text-white">
            <table class="main-table manage-members text-center table table-bordered  text-white">
                <tr >
                    <th class="text-warning">#ID</ف>
                    <th class="text-warning"> الاسم</th>
                    <th class="text-warning"> الرابط او رقم الهاتف </>
                    <th class="text-warning"> الايقونة</th>
                ...
                <tr>
                    ...
                    <td > <i class="{{$information->icon}}"></i></td>
