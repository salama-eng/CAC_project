        ...
        <div class="table-responsive text-white ms-5">
            <table class="main-table manage-members text-center table table-bordered  text-white">
                <tr style="  vertical-align: center !important;" >
                    <td  class="text-warning align-middle">#ID</td>
                    <td class="text-warning align-middle"> الاسم</td>
                    <td class="text-warning align-middle"> الايميل</td>
                    <td class="text-warning align-middle"> الهاتف</td>
                    <td class="text-warning align-middle"> الصورة</td>
                    <td class="text-warning align-middle"> العنوان</td>
                    <td class="text-warning align-middle"> الوصف</td>
                    <td class="text-warning align-middle">التحكم</td>
                </tr>
                ...
                <tr>
                    <td>{{$i++}}</td>
                    <td class="text-warning align-middle"> {{$membership->name}}</td>
                    <td class="text-warning align-middle"> {{$membership->email}}</td>
                    <td class="text-warning align-middle"> {{$membership->phone}}</td>
                    <td class="text-warning align-middle"><img src="{{ URL::asset('images/'.$membership->image) }}" width="80" alt="{{$membership->image}}" ></td>
                    <td class="text-warning align-middle"> {{$membership->address}}</td>
                    <td class="text-warning align-middle"> {{$membership->description}}</td>
