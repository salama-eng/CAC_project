...
@section('content')
    ...
    @if ($do == 'Manage')
<!-- start page Content -->
        <h1 class="text-center fs-3 text-white my-5">ادارة صور السلايدر</h1>
        <div class="container">
            ...
            <div class="table-responsive text-white ms-5">
                <table class="main-table manage-members text-center table table-bordered  text-white">
                    <tr>
                        ...
                        <th class="text-warning"> الصورة</th>
                        <th class="text-warning">تعديل</th>
                        <th class="text-warning">تفعيل</th>
                    </tr>
                    ...
                    @foreach ($Slider as $slider)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center align-items-center">
                                <a href="slider_image?do=Edit&sliderid={{ $slider->id }}" class="edit">
