                    ...
                    <ul class="collapse list-unstyled fs-6 mt-0" id="manage">
                        <li class="d-flex align-items-center justify-content-center">
                            <a href="{{ route('admin_posts') }}"
                                class="{{ Request::segment(1) === 'admin_posts' ? 'active' : 'text-light' }} text-center py-3 ps-3 pe-2"> <i class="bi bi-clipboard2-check-fill me-5 p-2 "></i>   إدارة
                               طلبات تقديم المزاد</a>
                        </li>
                        <li class="d-flex align-items-center justify-content-center">
                            <a href="{{ route('Start_auction') }}"
                                class="{{ Request::segment(1) === 'Start_auction' ? 'active' : 'text-light' }} text-center py-3 ps-3 pe-2"><i class="bi bi-card-checklist me-5 p-2 "></i>  إدارة
                                العروض</a>
                        </li>
                        <li class="d-flex align-items-center justify-content-center">
