                ...
                <ul class="list-unstyled components fs-6 mt-4 ">
                    ...
                    <li>
                        <a href="{{ route('AdminDash') }}"
                            class="{{ Request::segment(1) === 'AdminDash' ? 'active' : 'text-light' }}  p-3">
                            <i class="bi bi-house-fill active mx-2"></i> الرئيسية</a>
                    ...
                    <li>
                        <a href="admin_wallet"
                            class="{{ Request::segment(1) === 'admin_wallet' ? 'active' : 'text-light' }}  p-3">
                            <i class="bi bi-cash-stack active mx-2">  </i>    معلومات المحفضة</a>

                    </li>

                    <li class=" dropdown">
                        <a class="dropdown-toggle text-light p-3 " data-toggle="collapse"
                            aria-expanded="false"> <i class="bi bi-columns-gap active mx-2"></i> إدارة
                            المزادات</a>
                    </li>
                    <ul class="collapse list-unstyled fs-6 mt-0" id="manage">
                        <li class="">
                            <a href="{{ route('admin_posts') }}"
                                class="{{ Request::segment(1) === 'admin_posts' ? 'active' : 'text-light' }}  py-3 ps-3 pe-2"> <i class="bi bi-clipboard2-check-fill me-5 p-2 "></i>   إدارة
                               طلبات تقديم المزاد</a>
                        </li>
                        <li>
                            <a href="{{ route('Start_auction') }}"
                                class="{{ Request::segment(1) === 'Start_auction' ? 'active' : 'text-light' }}  py-3 ps-3 pe-2"><i class="bi bi-card-checklist me-5 p-2 active"></i>  إدارة
                                العروض</a>
                        </li>
                        <li class="">
                            <a href="{{ route('admin_acution') }}"
                                class="{{ Request::segment(1) === 'admin_acution' ? 'active' : 'text-light' }}  py-3 ps-3 pe-2"><i class="bi bi-clipboard2-plus-fill me-5 p-2 active"></i>   إدارة
                                المزادات
                                الحالية</a>
                        </li>
                        <li>
                            <a href="{{ route('un_complate') }}"
                                class="{{ Request::segment(1) === 'un_complate' ? 'active' : 'text-light' }}  py-3 ps-3 pe-2"><i class="bi bi-clipboard2-x-fill  me-5 p-2 active"></i>  إدارة
                                المزادات المعلقة</a>
                        </li>
                        <li>
                           <a href="{{ route('endede_acution') }}"
                                class="{{ Request::segment(1) === 'endede_acution' ? 'active' : 'text-light' }} py-3 ps-3 pe-2"> <i class="bi bi-clipboard2-check-fill me-5 p-2 active"></i> إدارة
                                المزادات المكتملة</a>
                        </li>
                    ...
                    <li>
                        <a href="{{ route('showAllUsers') }}"
                            class=" p-3 {{ Request::segment(1) === 'showAllUsers' ? 'active' : 'text-light' }}"><i class="bi bi-people-fill active mx-2"></i>  إدارة
                            المستخدمين</a>

                    </li>
                    <li>
                        <a href="{{ route('admincategories') }}"
                            class="text-center p-3 {{ Request::segment(1) === 'admincategories' ? 'active' : 'text-light' }}"> <i class="bi bi-menu-up active mx-2"></i> إدارة
                            تصنيفات
                            السيارات</a>
                    ...
                    <li>
                        <a href="{{ route('adminPayments') }}"
                            class="text-center p-3 {{ Request::segment(1) === 'adminPayments' ? 'active' : 'text-light' }}"><i class="bi bi-credit-card active mx-2"></i>  إدارة
                            طرق الدفع</a>
