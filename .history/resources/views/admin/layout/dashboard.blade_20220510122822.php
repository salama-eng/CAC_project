            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled components fs-6 mt-4 ">
                    ...
                    <ul class="collapse list-unstyled fs-6 mt-0" id="manage2">
                        ...
                        <li><a href="{{ route('manage_contact_us') }}" class="text-light text-center p-3"> ادارة صفحة
                                تواصل معنا </a></li>
                        <li><a href="{{ route('manage_about_us') }}" class="text-light text-center p-3"> ادارة صفحة من
                                نحن </a></li </ul>
                    ...
                    <li class="active dropdown3">
                        ...
                        <ul class=" list-unstyled fs-6" id="manage3">
                            <li><a href="{{ route('manage_message') }}" class="text-light text-center p-3"> الرسائل
                                    التي لم يرد عليها </a></li>
                            <li><a href="{{ route('complet_message') }}" class="text-light text-center p-3"> الرسائل
                                    التي تم الرد عليها </a></li>
                    ...
                    @foreach (auth()->user()->unreadNotifications as $notification)
                        <li>
                            ...
                            <a class="dropdown-item text-light fs-7"
                                href="{{ $notification->data['lesson'] }}">{{ $notification->data['lesson']['title'] }}
                                {{ auth()->user()->name }}
                                <i class="semiOrange fs-8 "><br></i>{{ $notification->data['lesson']['body'] }}
                                {{ $notification->data['lesson']['username'] }}</a>
