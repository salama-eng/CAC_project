                    ...
                    <ul class="collapse list-unstyled fs-6 mt-0" id="manage">
                        ...
                        <li class="d-flex align-items-center justify-content-center">
                            <a href="{{ route('admin_acution') }}"
                                class="{{ Request::segment(1) === 'admin_acution' ? 'active' : 'text-light' }}  py-3 ps-3 pe-2">إدارة
                                المزادات
                                الحالية</a>
                        </li>
                        <li class="d-flex align-items-center justify-content-center">
                            <a href="{{ route('un_complate') }}"
                                class="{{ Request::segment(1) === 'un_complate' ? 'active' : 'text-light' }}  py-3 ps-3 pe-2"><i class="bi bi-clipboard2-plus-fill me-5 p-2"></i>  إدارة
