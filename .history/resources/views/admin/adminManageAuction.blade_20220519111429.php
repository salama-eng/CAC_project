                    ...
                    @if($auction->auction_post->is_active == 1 && $auction->auction_post->end_date >= date('Y-m-d') && $auction->auction_post->status_auction == 0)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center align-items-center">
                                ...
                                @if($auction->auction_post->is_active == 1)
                        ...
                        <div class="modal-content bg-dark">
                            <form action="unactive" method="post">
                                ...
                                <div class="modal-body">
                                    <h2>هل انت متاكد</h2>
                                    <input type="hidden" name="postid" value="{{$auction->auction_post->id}}">
                                    <input type="hidden" name="userid" value="{{$auction->auction_post->user_id}}">
                                    <input type="hidden" name="is_active" value="{{$auction->auction_post->is_active}}">
                                </div>
