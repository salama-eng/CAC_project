...
@section('content')
    ...
    <style>
        ...
        <h1 class="text-center fs-3  text-white my-4">ادارة المستخدمين</h1>
        <div class="col-lg-4 col-8 mx-auto mb-5 mt-0">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control search-input search w-75 py-4" placeholder="ابحث عن المستخدم" aria-label="Username" aria-describedby="basic-addon1">
              </div>
