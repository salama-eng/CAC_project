...
<h1 class="text-center  text-white">ادارة طرق الدفع</h1>
    <div class="container">
        ...
        @endif
        <a href="" class="btn1 btn-sm text-white" data-bs-toggle="modal" data-bs-target="#addPayment">
            <i class="fa fa-plus"></i> اضافة طريقة دفع
        </a>
        ...
        <a href="adminPayments?do=Add" class="btn btn-sm btn-primary">
        ...
        @if($Payment->id == $Paymentid)
            <form action="edit_admin_Payment" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8 col-md-9">
                        <input type="text" name="Payment" value="{{$Payment->name}}" class="form-control" autocomplete="off" placeholder="ادخل طريقة الدفع ">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label text-white"> اسم البنك  </label>
                    <div class="col-sm-8 col-md-9">
                        <input type="text" name="bank_name" value="{{$Payment->bank_name}}" class="form-control" autocomplete="off" placeholder="ادخل اسم البنك">
                    </div>
                </div>  
                <!-- End Payment -->
                <!-- Start Submit -->
