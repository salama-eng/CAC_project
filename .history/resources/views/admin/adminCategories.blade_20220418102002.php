        ...
        <div class="table-responsive text-white">
            <table class="main-table manage-members text-center table table-bordered  text-white">
                ...
                <tr>
                    ...
                    <td>
                        <a href="adminCategory?do=Edit&categorytid={{$category->id}}" class="btn btn-success">
...
<div class="container">
    ...
    @endif
    <form action="add_admin_category" method="POST">
    @csrf
        <!-- Start Payment -->
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-white">طريقة دفع جديدة </label>
            <div class="col-sm-8 col-md-9">
                <input type="text" name="name" class="form-control" autocomplete="off" placeholder=" اضف طريقة دفع">
            </div>
        </div>
                <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-white">اسم البنك   </label>
            <div class="col-sm-8 col-md-9">
                <input type="file" name="image" class="form-control" autocomplete="off" placeholder="اسم البنك  ">
            </div>
        </div>
        <!-- End Payment -->
        <!-- Start Submit -->
