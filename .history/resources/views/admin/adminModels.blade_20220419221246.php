...
<h1 class="text-center  text-white">ادارة الموديلات</h1>
    <div class="container container-for-input">
        ...
        @endif
        <a  href="adminModels?do=Add" class="btn btn-sm btn-primary mb-2">
    ...
    @csrf
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-8 col-md-9">
                <input  type="text" name="model" class="form-control " autocomplete="off" placeholder="اضف موديل جديد" style=" background-color:aqua">
            </div>
        </div>
        <!-- End Model -->
        <!-- Start Submit -->
