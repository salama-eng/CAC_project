...
<div class="container">
    ...
    @csrf
        ...
        <div class="form-check d-flex flex-start justify-content-center mb-3 m-auto ">
         
          <input class="form-check-input col-6" type="checkbox" id="blankCheckbox" value="option1" aria-label="...">
          <label class="col-6 mx-4" for="">تفعيل</label>    </div>
        <!-- End category -->
        <!-- Start Submit -->
        <div class="mb-2 row">
