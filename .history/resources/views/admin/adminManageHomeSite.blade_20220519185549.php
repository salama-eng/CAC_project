...
{{$column = $_GET['column'];}}
{{$name = $_GET['name'];}}
<h1 class="text-center fs-3 mb-5 active">تعديل المحتوى</h1>
<div class="container col-lg-8 col-11 ">
            <form action="{{ route('edit_home_content',$contentid) }}"  method="POST" enctype="multipart/form-data" >
                ...
                <div class="mb-3 row ">
                    ...
                    <div class="col-sm-8 col-md-9 site-manage">
                        <textarea name="{{$column}}" cols="30" class="form-control  mb-0 p-5" style="border:none ;  background-color:transparent !important;   " rows="7">
                        {{$Content[0]->$column}}
                        </textarea>
