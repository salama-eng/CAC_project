...
@elseif($do == 'Add')
<!-- start add model -->
<h1 class="text-center fs-3 m-4"> اضافة صنف  </h1>
<div class="container col-lg-9 col-11">
    ...
    @csrf
        <!-- Start Payment -->
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-white"> إضافة تصنيف جديد  </label>
            <div class="col-sm-8 col-md-9">
                <input type="text" name="name" class="form-control input" autocomplete="off" placeholder=" اضف تصنيف  ">
            </div>
        </div>
                <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-white"> أضف صورة </label>
            <div class="col-sm-8 col-md-9">
                <input type="file" name="image" class="form-control input" autocomplete="off">
            </div>
        </div>
