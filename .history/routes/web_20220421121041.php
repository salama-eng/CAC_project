...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/UserUncomplatePosts', [UserPostsController::class, 'uncompate'])->name('UserUncomplatePosts');
    Route::get('/UserComplatePosts', [UserPostsController::class, 'compate'])->name('UserComplatePosts');
