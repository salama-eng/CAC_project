     ...
     public function test_Authirzation_Admin_dash()
     {
      ...
      public function test_Authirzation_Admin_dash_if_login()
      {
       ...
       public function test_Authirzation_Admin_manage_categories_if_login()
       {
        ...
        public function test_accept_auction_Authirzation_Admin()
        {
            Auth::check();
            $this->withoutExceptionHandling();
                $admin = User::find(1);
        ...
        public function test_show_uncomplate_auction_Authirzation_Admin()
        {
            Auth::check();
            $this->withoutExceptionHandling();
                $admin = User::find(1);
                ...
                $response=(new AuctionsAdminController)->showAdminAuction();
            
                // $response = $this->get('endede_acution');
                $this->assertnotEmpty($response);
         }
}
