                ...
                <ul class="list-unstyled components fs-6 mt-4 ">
                    ...
                    <li class="active dropdown">
                        ...
                        <ul class="collapse list-unstyled fs-6" id="manage">
                            ...
                            <li><a href="#" class="text-light text-center p-3"> السيارات المضافة في المزاد</a></li>
                ...
                <ul class="dropdown-menu bg-dark userinfo text-center p-0">
                    <li>
                       <div class="d-flex flex-column justify-center">
                        ...
                        <img src="assets/images/avatar.png" class=" rounded-circle m-auto mt-1 " width="50" alt="" >
</div>
