                ...
                <table class="main-table manage-members text-center table table-bordered  text-white">
                    ...
                    @foreach ($category as $category)
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>{{ $category->name }}</td>
                            <td><img src="{{ URL::asset('images/' . $category->image) }}" width="80"
                            ...
                            <td class="d-flex justify-content-center align-items-center">
                                ...
                                @if ($category->is_active == 1)
                                    <label class="switch" data-bs-toggle="modal"
                                        data-bs-target="#activeCategory{{ $category->id }}">
                        ...
                        <div class="modal fade user" id="deleteCategory{{ $category->id }}" tabindex="-1"
                        ...
                        <div class="modal fade user" id="activeCategory{{ $category->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
